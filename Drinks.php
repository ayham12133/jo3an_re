        ...
        <div class="gallery">
            ...
            $result = $database->getData();
                while ($row = mysqli_fetch_assoc($result)){
                    component4($row['product_name'], $row['product_price'],  $row['product_image'], $row['id'],$row['_desc']);
           ...
           <!-- <div class="desc">
            ...
            <h4>Smoothie</h4>
                <p><small>Cherry, Blueberry, Strawberry, mango</small></p>
            ...
            <h4>Frappe</h4>
                <p><small>Oreo, Caramel, nutella</small></p>
            ...
            <h3>Espresso</h3>
                <p><small>Freshly toasted coffe beans is what makes our espresso addictive</small></p>
